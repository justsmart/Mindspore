...
class Attention(nn.Cell):
    def __init__(self,
        ...
        self.attn_drop = nn.Dropout(p=attention_keep_prob)
        self.out = nn.Dense(dim, dim)
        self.out_drop = nn.Dropout(p=keep_prob)
...
class Trans(nn.Cell):
    def __init__(self,
        ...
        # self.pool = pool
        self.pos_dropout = nn.Dropout(p=keep_prob)
