...
if __name__=='__main__':
    ...
    dataloder,dataset = getIncDataloader('/home/liucl/MATLAB-NOUPLOAD/MyMVML-data/corel5k/corel5k_six_view.mat','/home/liucl/MATLAB-NOUPLOAD/MyMVML-data/corel5k/corel5k_six_view_MaskRatios_0.5_LabelMaskRatio_0.5_TraindataRatio_0.7.mat',training_ratio=0.7,mode='train',batch_size=3,num_workers=2)
    iterator = dataloder.create_tuple_iterator()

    # for i,(data0,data1,data2,data3,data4,data5 , label, inc_V_ind, inc_L_ind) in enumerate(iterator):
        # print(data5.shape)
